...
import com.circustar.mybatis_accessor.provider.command.UpdateByIdCommand;
...
public class DefaultSaveOrUpdateProcessorProvider extends AbstractUpdateEntityProvider<DefaultEntityProviderParam> {

    private final ISelectService selectService;

    public DefaultSaveOrUpdateProcessorProvider(ApplicationContext applicationContext, ISelectService selectService) {
