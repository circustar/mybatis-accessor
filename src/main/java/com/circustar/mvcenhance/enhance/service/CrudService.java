...
//    public void deleteByIds(EntityDtoServiceRelation relation, String idName
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void deleteById(EntityDtoServiceRelation relation, String idName
//            , Serializable id
//            , List<String> subEntities, boolean physic) throws UpdateFailException {
//        IService service = (IService)applicationContext.getBean(relation.getService());
//        if(subEntities != null && subEntities.size() > 0) {
...
//                FieldUtils.setFieldByName(o, keyProperty, idValue);
//            }
...
//            FieldUtils.setFieldByName(subEntity, keyProperty, idValue);
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void save(EntityDtoServiceRelation relation
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void saveList(EntityDtoServiceRelation relation
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void saveOrUpdateOrDeleteList(EntityDtoServiceRelation relation
...
//            FieldUtils.setFieldByName(obj, tableInfo.getKeyProperty(), idValue);
//        }
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void update(EntityDtoServiceRelation relation
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void updateSubEntityList(EntityDtoServiceRelation relation
...
//    @Override
//    @Transactional(rollbackFor = Exception.class)
//    public void businessUpdate(List<UpdateEntity> objList) throws Exception {
//        boolean result = false;
...
//    }
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public List<Object> updateByProviders(EntityDtoServiceRelation relationInfo, Object object, String[] updateNames, Object[] options, BindingResult bindingResult) throws Exception {
        ...
        for(IUpdateEntityProvider provider : providers) {
            provider.validateAndSet(object, bindingResult);
